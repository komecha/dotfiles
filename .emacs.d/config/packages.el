...
(require 'package)
;; ~/.emacs.d/packages/ 以下の全ディレクトリをload-pathに追加
(defconst my-elisp-directory "~/.emacs.d/packages" "The directory for my elisp file.")
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;lookup(EPWING閲覧)
;;(setq load-path (cons "/home/user/.emacs.d/packages/lookup" load-path))
     ;; オートロードの設定
...
(require 'lispxmp)
;; emacs-lisp-modeでC-c C-dっを押すと注釈
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; auto-async-byte-compile.el 保存時に自動コンパイル
...
;; (add-hook 'lisp-interaction-mode-hook 'turn-on-eldoc-mode)
;; (add-hook 'ielm-mode-hook 'turn-on-eldoc-mode)
;; (setq eldoc-idle-delay 0.2)		;今すぐに表示
